              ...
              <div id="productMain" class="row">
                <div class="col-sm-6">
                  <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                    <div> <img src="Images\products\Diva\4147 40 C829 A.jpg" alt="" class="img-fluid"></div>
                    <div> <img src="Images\products\Diva\4147 40 C829 F.jpg" alt="" class="img-fluid"></div>
                    
                  </div>
                  <div data-slider-id="1" class="owl-thumbs">
                    <button class="owl-thumb-item"><img src="Images\products\Diva\4147 40 C829 A.jpg" alt="" class="img-fluid"></button>
                    <button class="owl-thumb-item"><img src="Images\products\Diva\4147 40 C829 F.jpg" alt="" class="img-fluid"></button>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="box">
                    <form>
                      <div class="sizes">
                        <h3>Diva Sunglasses</h3>
                       
                      </div>
                      <p class="price">$124.00</p>
                      <p class="text-center">
                        <button type="submit" class="btn btn-template-outlined"><i class="fi-xnsuxl-camera-solid"></i> Try-On</button><br><br>
